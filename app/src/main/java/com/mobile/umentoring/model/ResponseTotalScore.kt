...
data class ResponseTotalScore(

	@field:SerializedName("data")
	val data: DataTotalScore? = null,
...
data class DataTotalScore(
	...
	val participant: ParticipantTotalScore? = null,
...
data class ParticipantTotalScore(
